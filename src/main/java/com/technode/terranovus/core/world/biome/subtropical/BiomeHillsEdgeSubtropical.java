...
public class BiomeHillsEdgeSubtropical extends BiomeHillsEdgeTN {

    public static enum MoistureType {ARID, VERY_DRY, DRY, AVERAGE, DAMP, VERY_DAMP, WET}

    public BiomeHillsEdgeSubtropical.MoistureType type;

    public BiomeHillsEdgeSubtropical(BiomeHillsEdgeSubtropical.MoistureType type)
    {
