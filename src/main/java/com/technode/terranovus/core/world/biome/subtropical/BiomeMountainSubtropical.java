...
public class BiomeMountainSubtropical extends BiomeMountainTN {

    public static enum MoistureType {ARID, VERY_DRY, DRY, AVERAGE, DAMP, VERY_DAMP, WET}

    public BiomeMountainSubtropical.MoistureType type;

    public BiomeMountainSubtropical(BiomeMountainSubtropical.MoistureType type)
    {
