...
public class BiomeSwampSubtropical extends BiomeSwampTN {

    public static enum MoistureType {ARID, VERY_DRY, DRY, AVERAGE, DAMP, VERY_DAMP, WET}

    public BiomeSwampSubtropical.MoistureType type;

    public BiomeSwampSubtropical(BiomeSwampSubtropical.MoistureType type)
    {
