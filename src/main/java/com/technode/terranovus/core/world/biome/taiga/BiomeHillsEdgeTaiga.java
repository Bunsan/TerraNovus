...
public class BiomeHillsEdgeTaiga extends BiomeHillsEdgeTN {

    public static enum MoistureType {ARID, VERY_DRY, DRY, AVERAGE, DAMP, VERY_DAMP, WET}

    public BiomeHillsEdgeTaiga.MoistureType type;

    public BiomeHillsEdgeTaiga(BiomeHillsEdgeTaiga.MoistureType type)
    {
