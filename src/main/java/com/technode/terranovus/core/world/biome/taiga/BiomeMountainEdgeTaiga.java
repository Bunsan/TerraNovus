...
public class BiomeMountainEdgeTaiga extends BiomeMountainEdgeTN {

    public static enum MoistureType {ARID, VERY_DRY, DRY, AVERAGE, DAMP, VERY_DAMP, WET}

    public BiomeMountainEdgeTaiga.MoistureType type;

    public BiomeMountainEdgeTaiga(BiomeMountainEdgeTaiga.MoistureType type)
    {
