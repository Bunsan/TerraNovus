...
public class BiomeSwampTemperate extends BiomeSwampTN {

    public static enum MoistureType {ARID, VERY_DRY, DRY, AVERAGE, DAMP, VERY_DAMP, WET}

    public BiomeSwampTemperate.MoistureType type;

    public BiomeSwampTemperate(BiomeSwampTemperate.MoistureType type)
    {
