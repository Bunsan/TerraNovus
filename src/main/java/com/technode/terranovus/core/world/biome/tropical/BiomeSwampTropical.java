...
public class BiomeSwampTropical extends BiomeSwampTN {

    public static enum MoistureType {ARID, VERY_DRY, DRY, AVERAGE, DAMP, VERY_DAMP, WET}

    public BiomeSwampTropical.MoistureType type;

    public BiomeSwampTropical(BiomeSwampTropical.MoistureType type)
    {
